...
import tarfile# open file
file = tarfile.open('pretrained_bert_tf-1.tar.gz')
  
# extracting file
file.extractall('./pretrained_bert_tf/pretrained_bert_tf')
  
file.close()

# +

file = tarfile.open('./pretrained_bert_tf/pretrained_bert_tf/biobert_pretrain_output_all_notes_150000.tar.gz')
  
# extracting file
file.extractall('./pretrained_bert_tf/pretrained_bert_tf/biobert_pretrain_output_all_notes_150000')
...
model_loc = 'pretrained_bert_tf/pretrained_bert_tf/biobert_pretrain_output_all_notes_150000/biobert_pretrain_output_all_notes_150000/'
